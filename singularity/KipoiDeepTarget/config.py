...
https://localhost/fchollet/keras/blob/6f3e6bb6fc97e706f37dc078ae821f490b78035b/keras/backend/__init__.py#L14-L43
"""
import os
...
def model_sources():
    if _MODEL_SOURCES:
        ...
        return {
            "kipoi": GitSource(remote_url="https://localhost/kipoi/models.git",
